    ...
    const getLocation = async () => {
      try {
        ...
        if (granted === PermissionsAndroid.RESULTS.GRANTED) {
          ...
          alert('This App needs to Access your location');
          navigation.goBack();
        }
      } catch (err) {
        console.warn(err);
          ...
          <Card
            ...
            <View style={{flex: 0.5}}>
              <View style={styles.subCon3}>
                ...
                <Text style={styles.text3}>{geolocation.lon}</Text>
              </View>
              <View style={styles.subCon3}>
            ...
            <View style={{flex: 0.5}}>
              <View style={styles.subCon3}>
                <Text style={[styles.text2, {color: '#d9d9d9'}]}>Latitude</Text>
                <Text style={styles.text3}>{geolocation.lat}</Text>
              </View>
              <View style={styles.subCon3}>
